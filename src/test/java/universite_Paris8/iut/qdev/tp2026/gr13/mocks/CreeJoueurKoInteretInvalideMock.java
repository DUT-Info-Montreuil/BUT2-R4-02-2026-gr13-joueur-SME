...
import universite_Paris8.iut.qdev.tp2026.gr13.utils.exceptions.InteretFormatException;

public class CreeJoueurKoInteretInvalideMock implements IservicesJoueur {

    @Override
    public JoueurDTO creeJoueur(String prenom, String pseudo, Integer anneeNaissance, String centresInterets, Integer codeLangue)
            throws InteretFormatException {
        throw new InteretFormatException();
    }
}